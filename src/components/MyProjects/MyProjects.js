...
const MyProjects = () => {
    return (
     <div>
        ...
        <h2 className='text-center text-4xl my-5 font-bold'>My Projects</h2>
           <div className='grid lg:grid-cols-3 mx-auto sm:grid-cols-1 md:grid-cols-2 gap-5 text-white' style={{ backgroundImage: `url(${img})` }} >
  ...
  <div className="card-body">
    ...
    <a href="https://sellcell-f5de6.web.app">  <button className="btn btn-active btn-secondary">View Details</button></a>
    </div>
  </div>
</div>
...
<div className="card w-96 bg-black shadow-xl">
  ...
  <div className="card-body">
    ...
    <div className="card-actions justify-end">
<a href="https://code-planner-f4fc4.web.app">   <button className="btn btn-active btn-secondary">View Details</button></a>
...
<div className="card w-96 bg-black shadow-xl">
  ...
  <div className="card-body">
    ...
    <div className="card-actions justify-end">
 <a href="https://journalist-5a23f.web.app"> <button className="btn btn-active btn-secondary">View Details</button></a>
    </div>
  </div>
</div>
        </div>
